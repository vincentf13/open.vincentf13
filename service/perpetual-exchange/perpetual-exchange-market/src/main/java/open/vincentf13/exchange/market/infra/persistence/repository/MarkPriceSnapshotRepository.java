...
import open.vincentf13.exchange.market.infra.persistence.mapper.MarkPriceSnapshotMapper;
...
public class MarkPriceSnapshotRepository {
  ...
  public Optional<MarkPriceSnapshot> findLatest(@NotNull Long instrumentId) {
    LambdaQueryWrapper<MarkPriceSnapshotPO> wrapper =
        Wrappers.lambdaQuery(MarkPriceSnapshotPO.class)
    ...
    return Optional.ofNullable(po)
        .map(value -> OpenObjectMapper.convert(value, MarkPriceSnapshot.class));
  }
}
