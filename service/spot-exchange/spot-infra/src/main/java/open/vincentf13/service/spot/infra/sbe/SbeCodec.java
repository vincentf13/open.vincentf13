...
public class SbeCodec {
    ...
    public static int encode(MutableDirectBuffer buffer,
                             int offset,
                             OrderCreateEncoder encoder) {
    ...
    public static int encode(MutableDirectBuffer buffer,
                             int offset,
                             ExecutionReportEncoder encoder) {
        HEADER_ENCODER.get().wrap(buffer, offset)
                      .blockLength(encoder.sbeBlockLength())
                      .templateId(encoder.sbeTemplateId())
                      .schemaId(encoder.sbeSchemaId())
    ...
    public static void decode(DirectBuffer buffer,
                              int offset,
                              OrderCreateDecoder decoder) {
    ...
    public static void decode(DirectBuffer buffer,
                              int offset,
                              ExecutionReportDecoder decoder) {
        MessageHeaderDecoder header = HEADER_DECODER.get();
        header.wrap(buffer, offset);
        decoder.wrap(buffer, offset + MessageHeaderDecoder.ENCODED_LENGTH, header.blockLength(), header.version());
    }
