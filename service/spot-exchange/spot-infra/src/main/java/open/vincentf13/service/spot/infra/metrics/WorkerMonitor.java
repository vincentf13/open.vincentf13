...
public class WorkerMonitor {
    ...
    /** 標記循環開始 */
    public static void startCycle() { CYCLE_COUNTERS.get()[0]++; }
    
    /** 標記循環結束並記錄是否有工作 */
    public static void endCycle(boolean worked) { if (worked) CYCLE_COUNTERS.get()[1]++; }
    ...
    public static void reportThreadMetrics(long cpuIdKey, long loadKey) {
        MetricsCollector.set(loadKey, getAndResetDutyCycle());
