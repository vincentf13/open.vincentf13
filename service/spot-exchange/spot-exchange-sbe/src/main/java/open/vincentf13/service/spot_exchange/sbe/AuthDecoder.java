...
public final class AuthDecoder
{
    ...
    private final AuthDecoder parentMessage = this;
    ...
    public AuthDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public String toString()
    {
        ...
        final AuthDecoder decoder = new AuthDecoder();
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[Auth](sbeTemplateId=");
