...
import static open.vincentf13.service.spot.infra.Constants.ChronicleWireKey;
...
public class ExecutionReporter {
     ...
     */
    public void sendReport(long uid,
                           long oid,
                           String cid,
                           OrderStatus s,
                           long lp,
    ...
    /**
     重發訂單回報 (用於冪等性補發)
     */
    public void resendReport(Order o,
                             long gwSeq) {
    ...
    /**
     發送認證成功回報
     */
    public void sendAuthSuccess(long userId,
                                long gwSeq,
                                boolean isReplaying) {
        if (isReplaying)
            return;
