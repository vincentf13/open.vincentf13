...
public class OrderBook {
    ...
    static {
        for (int i = 0; i < 200_000; i++) {
            ...
            if (i < 20_000) TRADE_POOL.add(new Trade());
    ...
    public Order handleCreate(long orderId, long userId, int symbolId, long price, long qty, Side side, long clientOrderId, long timestamp, long gwSeq,
                             long frozenAmount, open.vincentf13.service.spot.model.WalProgress progress, TradeFinalizer finalizer) {
    ...
    private Long2ObjectRBTreeMap<Deque<Order>> getTree(boolean buySide) { return buySide ? bids : asks; }
    private Long2ObjectHashMap<Deque<Order>> getLevels(boolean buySide) { return buySide ? bidLevels : askLevels; }
