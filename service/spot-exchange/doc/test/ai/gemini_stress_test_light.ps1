# ==============================================================================
# Aeron 交易系統自動化部署與啟動腳本 (Gemini 輕量驗證版)
# ==============================================================================
...
# Note: Since .args also has -Xms8G, we put -Xms2G before @args, wait, the last one wins in some JVMs, or it might error.
# Better to use absolute command line without @args or modify @args temporarily.
# Actually JVM takes the LAST value for Xms/Xmx.
