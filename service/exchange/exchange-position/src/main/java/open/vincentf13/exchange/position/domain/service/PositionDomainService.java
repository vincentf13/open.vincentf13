...
public class PositionDomainService {
    ...
    public ReserveForCloseResult calculateReserveForClose(Position position, BigDecimal quantity) {
        if (position == null) {
    ...
    public TradeExecutionResult processTradeExecution(
            Position position,
            OrderSide orderSide,
            BigDecimal price,
            BigDecimal quantity,
    ...
    public record ReserveForCloseResult(
            boolean success,
            BigDecimal newReservedQuantity,
            BigDecimal avgOpenPrice,
            String reason
    ) {
        public static ReserveForCloseResult accepted(BigDecimal newReservedQuantity, BigDecimal avgOpenPrice) {
    ...
    public record TradeSplit(
            BigDecimal closeQuantity,
            BigDecimal flipQuantity
    ) {
    }
}
