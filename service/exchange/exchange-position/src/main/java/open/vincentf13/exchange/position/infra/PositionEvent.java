...
public enum PositionEvent implements OpenEvent {
  POSITION_TRADE_SETTLEMENT_FAILED(
      "PositionTradeSettlementFailed", "Trade settlement handling failed"),
  ...
  STARTUP_LOADING_INSTRUMENTS(
      "PositionStartupLoadingInstruments", "Loading instruments from Admin service"),
  STARTUP_INSTRUMENTS_LOADED("PositionStartupInstrumentsLoaded", "Instruments loaded successfully"),
  STARTUP_LOADING_RISK_LIMITS(
      "PositionStartupLoadingRiskLimits", "Loading risk limits from Risk service"),
  STARTUP_RISK_LIMITS_LOADED("PositionStartupRiskLimitsLoaded", "Risk limits loaded successfully"),
  STARTUP_RISK_LIMIT_FETCH_FAILED(
      "PositionStartupRiskLimitFetchFailed", "Failed to fetch risk limit for instrument"),
