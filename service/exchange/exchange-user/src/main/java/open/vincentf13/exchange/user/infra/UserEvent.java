...
public enum UserEvent implements OpenEvent {
  AUTH_CREDENTIAL_PERSIST_FAILED(
      "UserAuthCredentialPersistFailed", "Failed to persist auth credential"),
  AUTH_CREDENTIAL_RETRY_ERROR(
      "UserAuthCredentialRetryError", "Unexpected error while retrying credential creation"),
  AUTH_CREDENTIAL_RETRY_SUCCESS(
      "UserAuthCredentialRetrySuccess", "Successfully synchronized auth credential"),
