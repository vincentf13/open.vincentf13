...
public interface MarketApi {
  ...
  @PublicAPI
  OpenApiResponse<TickerResponse> getTicker(
      @PathVariable("instrumentId") @NotNull Long instrumentId);

  @GetMapping("/orderbook/{instrumentId}")
  @PublicAPI
  OpenApiResponse<OrderBookResponse> getOrderBook(
      @PathVariable("instrumentId") @NotNull Long instrumentId);

  @GetMapping("/kline")
  @PublicAPI
  OpenApiResponse<List<KlineResponse>> getKlines(
      @RequestParam("instrumentId") @NotNull Long instrumentId,
