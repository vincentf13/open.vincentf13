  ...
  void testDisasterRecoveryAndIdempotency() throws IOException {
    try {
        ...
        Order bigOrder = Order.builder()
            ...
            .submittedAt(Instant.now()).build();
        expectedOrders.add(bigOrder);
        processor1.processBatch(List.of(bigOrder));
        ...
        assertThat(recoveredOrders).hasSize(1001);
        ...
        System.out.println("數據驗證通過：1001 筆訂單的小數價格與整數數量狀態完全還原。");
        ...
        // 驗證冪等性
        processor2.processBatch(List.of(bigOrder));
        assertThat(recoveredBook.dumpOpenOrders()).hasSize(1001); 
        ...
        assertThat(finalOrders).hasSize(1000);
