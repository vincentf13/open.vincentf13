...
public class AccountEntry {
    ...
    public static AccountEntry userDeposit(Long entryId,
                                          Long accountId,
                                          Long userId,
                                          AssetSymbol asset,
                                          BigDecimal amount,
    ...
    public static AccountEntry platformDeposit(Long entryId,
                                              Long accountId,
                                              AssetSymbol asset,
                                              BigDecimal amount,
                                              Long counterpartyEntryId,
    ...
    public static AccountEntry userWithdrawal(Long entryId,
                                             Long accountId,
                                             Long userId,
                                             AssetSymbol asset,
                                             BigDecimal amount,
    ...
    public static AccountEntry platformWithdrawal(Long entryId,
                                                 Long accountId,
                                                 AssetSymbol asset,
                                                 BigDecimal amount,
                                                 Long counterpartyEntryId,
    ...
    public static AccountEntry userFundsFreeze(Long entryId,
                                              Long accountId,
                                              Long userId,
                                              AssetSymbol asset,
                                              BigDecimal amount,
    ...
    public static AccountEntry userFundsReserved(Long entryId,
                                                Long accountId,
                                                Long userId,
                                                AssetSymbol asset,
                                                BigDecimal amount,
    ...
    private static AccountEntry deposit(Long entryId,
                                       OwnerType ownerType,
                                       Long accountId,
                                       Long userId,
                                       AssetSymbol asset,
    ...
    public static AccountEntry settlement(Long entryId,
                                         Long accountId,
                                         Long userId,
                                         AssetSymbol asset,
                                         BigDecimal amount,
