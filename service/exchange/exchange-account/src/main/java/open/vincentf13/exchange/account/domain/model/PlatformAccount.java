...
public class PlatformAccount {
  ...
  @NotNull private PlatformAccountCode accountCode;
  ...
  public static PlatformAccount createDefault(PlatformAccountCode accountCode, AssetSymbol asset) {
  ...
  private PlatformJournal buildJournal(
  ...
  public PlatformAccount apply(Direction direction, BigDecimal amount) {
