...
public class UserAccount {
  ...
  @NotNull private UserAccountCode accountCode;
  private String accountName;
  private Long instrumentId;
  @NotNull private AccountCategory category;
  @NotNull private AssetSymbol asset;
  @NotNull private BigDecimal balance;
  @NotNull private BigDecimal available;
  @NotNull private BigDecimal reserved;
  private Integer version;
  private Instant createdAt;
  private Instant updatedAt;

  public static UserAccount createDefault(
      Long userId, UserAccountCode accountCode, Long instrumentId, AssetSymbol asset) {
  ...
  public UserAccount apply(Direction direction, BigDecimal amount) {
  ...
  public UserAccount applyAllowNegative(Direction direction, BigDecimal amount) {
    BigDecimal delta = AccountCategory.delta(category, direction, amount);
    BigDecimal newBalance = balance.add(delta);
    BigDecimal newAvailable = available.add(delta);
    return UserAccount.builder()
  ...
  public UserAccount applyTradeSettlement(BigDecimal totalReserved, BigDecimal feeRefund) {
  ...
  public MutationResult applyWithJournal(
      Direction direction,
      BigDecimal amount,
      Long journalId,
  ...
  public MutationResult applyAllowNegativeWithJournal(
      Direction direction,
      BigDecimal amount,
      Long journalId,
      ReferenceType referenceType,
  ...
  public MutationResult freezeWithJournal(
      BigDecimal amount,
  ...
  public MutationResult applyReservedOutWithJournal(
      BigDecimal amount,
      Long journalId,
      ReferenceType referenceType,
      String referenceId,
  ...
  public MutationResult refundReservedWithJournal(
      BigDecimal amount,
      Long journalIdAvailable,
      Long journalIdReserved,
      ReferenceType referenceType,
  ...
  private UserJournal buildJournal(
