...
export default function AccountPanel({refreshTrigger, onOpenBalanceSheet, onSyncComplete}: AccountPanelProps) {
    ...
    return (
        <div
            className="relative flex flex-col gap-4 p-4 rounded-2xl border border-white/25 bg-white/15 shadow-md overflow-hidden">
            <div
            ...
            <div className="space-y-3 text-xs">
                <div className="flex items-center justify-between gap-2 whitespace-nowrap">
                    <span
                        className="text-[10px] uppercase text-slate-400 font-bold tracking-wider truncate">Balance</span>
            ...
            {formatAmountWithAsset(balances.balance, balances.asset)}
                ...
                <div className="flex items-center justify-between gap-2 whitespace-nowrap">
                    <span
                        className="text-[10px] uppercase text-slate-400 font-bold tracking-wider truncate">Available</span>
                    <span className="text-sm font-mono font-medium text-slate-700 truncate">
            {formatAmountWithAsset(balances.available, balances.asset)}
                ...
                <div className="flex items-center justify-between gap-2 whitespace-nowrap">
                    <span
                        className="text-[10px] uppercase text-slate-400 font-bold tracking-wider truncate">Reserved</span>
                    <span className="text-sm font-mono font-medium text-slate-700 truncate">
