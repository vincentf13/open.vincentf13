        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <div
                        className={`liquid-input-group ${type === 'MARKET' ? 'bg-slate-100 cursor-not-allowed border-slate-200' : 'border-slate-300'}`}>
                        <input
                            type="number"
                            step="0.01"
                        ...
                        />
                        <div
                            className="flex items-center justify-end w-[60px] pr-3 border-l border-slate-200 bg-slate-50/50">
                ...
                <div className="space-y-1.5">
                        ...
                        <Tooltip
                            title={(
                                <div className="text-xs">
                                    ...
                                    <div className="whitespace-nowrap">Amount / contract size 會是最終下單的 Quantity。
                                    </div>
                                    ...
                                    <div className="whitespace-nowrap">Amount / contract size results in the final order
                                        Quantity.
                                    </div>
                                    <div className="whitespace-nowrap">Designed to improve internal floating-point
                    ...
                    <div className="liquid-input-group border-slate-300">
                        ...
                        />
                        <div
                            className="flex items-center justify-start w-[60px] pl-3 border-l border-slate-200 bg-slate-50/50">
                ...
                {displayLeverage !== null ? `${displayLeverage}x` : '--'}
                    ...
                    <div className="flex justify-between text-xs text-slate-500">
                        ...
                        <span
                            className="text-slate-700 font-medium">{formatRate(riskLimit?.maintenanceMarginRate)}</span>
                    </div>
                            ...
                            <Tooltip
                                title={(
                                    <div className="text-xs">
                                        ...
                                        <div className="whitespace-nowrap">Taker fee is reserved upon order placement.
                                        </div>
                                        <div className="whitespace-nowrap">The difference will be refunded if filled as
                                            a Maker.
                                        </div>
                                    </div>
                                )}
