...
public class AccountController implements AccountApi {
  ...
  @Override
  public OpenApiResponse<AccountBalanceResponse> getBalances(String asset, Long userId) {
    Long jwtUserId = OpenJwtLoginUserHolder.currentUserId();
    Long effectiveUserId = jwtUserId != null ? jwtUserId : userId;
  ...
  @Override
  public OpenApiResponse<AccountJournalResponse> getAccountJournals(
      Long accountId, Instant snapshotAt) {
    Long jwtUserId = OpenJwtLoginUserHolder.currentUserId();
    if (jwtUserId == null) {
      throw new IllegalArgumentException("Missing user context");
    }
    ...
    return OpenApiResponse.success(
        accountQueryService.getAccountJournals(jwtUserId, accountId, snapshotAt));
  }

  @Override
  public OpenApiResponse<AccountReferenceJournalResponse> getJournalsByReference(
    ...
    return OpenApiResponse.success(
        accountQueryService.getJournalsByReference(jwtUserId, referenceType, referenceId));
  }
  ...
  @Override
  public OpenApiResponse<PlatformAccountJournalResponse> getPlatformAccountJournals(
      Long accountId, Instant snapshotAt) {
    Long jwtUserId = OpenJwtLoginUserHolder.currentUserId();
    if (jwtUserId == null) {
      throw new IllegalArgumentException("Missing user context");
    ...
    return OpenApiResponse.success(
        accountQueryService.getPlatformAccountJournals(accountId, snapshotAt));
  }
}
