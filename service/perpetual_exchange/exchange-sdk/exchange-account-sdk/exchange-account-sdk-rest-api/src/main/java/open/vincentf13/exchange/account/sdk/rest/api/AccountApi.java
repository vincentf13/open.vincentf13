...
public interface AccountApi {
  ...
  @Jwt
  @PrivateAPI
  OpenApiResponse<AccountBalanceResponse> getBalances(
  ...
  @PrivateAPI
  @Jwt
  OpenApiResponse<AccountDepositResponse> deposit(
      @Valid @RequestBody AccountDepositRequest request);

  @PostMapping("/withdrawals")
  @PrivateAPI
  @Jwt
  OpenApiResponse<AccountWithdrawalResponse> withdraw(
  ...
  @GetMapping("/journals")
  @Jwt
  OpenApiResponse<AccountJournalResponse> getAccountJournals(
  ...
  @Jwt
  OpenApiResponse<AccountReferenceJournalResponse> getJournalsByReference(
      @RequestParam("referenceType") @NotNull ReferenceType referenceType,
  ...
  @Jwt
  OpenApiResponse<PlatformAccountJournalResponse> getPlatformAccountJournals(
      @RequestParam("accountId") @NotNull Long accountId,
      @RequestParam(value = "snapshotAt", required = false)
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
          Instant snapshotAt);
