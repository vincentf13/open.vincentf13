...
public class PlatformJournalRepository {
  ...
  public List<PlatformJournal> findByReference(
      @NotNull ReferenceType referenceType, @NotNull String referenceId) {
    if (referenceId.isBlank()) {
      return List.of();
    }
    var wrapper =
        Wrappers.<PlatformJournalPO>lambdaQuery()
  ...
  public List<PlatformJournal> findByAccountIdBefore(
  ...
  public Optional<PlatformJournal> findLatestBefore(
      @NotNull Long accountId, @NotNull Instant snapshotAt) {
    var wrapper =
        Wrappers.<PlatformJournalPO>lambdaQuery()
            .eq(PlatformJournalPO::getAccountId, accountId)
  ...
  public Map<Long, PlatformJournal> findLatestBefore(
