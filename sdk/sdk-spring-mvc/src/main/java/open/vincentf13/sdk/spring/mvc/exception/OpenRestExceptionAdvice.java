...
public class OpenRestExceptionAdvice implements MessageSourceAware {
  ...
  */
  ...
  public ResponseEntity<Object> handleValidationErrors(Exception ex, WebRequest request) {
    ...
    return buildErrorResponse(
        ...
        OpenErrorCodes.REQUEST_VALIDATION_FAILED,
        "error.validation",
  ...
  */
  ...
  public ResponseEntity<Object> handleMissingServletRequestParameter(
    ...
    return buildErrorResponse(
        ...
        HttpStatus.BAD_REQUEST,
        OpenErrorCodes.REQUEST_PARAMETER_MISSING,
  ...
  */
  ...
  public ResponseEntity<Object> handleHttpMessageNotReadable(
    ...
    return buildErrorResponse(
        servletRequest,
        HttpStatus.BAD_REQUEST,
        OpenErrorCodes.REQUEST_PAYLOAD_UNREADABLE,
        "error.bad-request",
  ...
  */
  ...
  public ResponseEntity<Object> handleHttpRequestMethodNotSupported(
    ...
    return buildErrorResponse(
        ...
        OpenErrorCodes.HTTP_METHOD_NOT_ALLOWED,
  ...
  public ResponseEntity<Object> handleConstraintViolation(
    ...
    Map<String, String> errors =
        ex.getConstraintViolations().stream()
            .collect(
                Collectors.toMap(
                    OpenRestExceptionAdvice::violationPath,
  ...
  */
  ...
  public ResponseEntity<OpenApiResponse<Object>> handleOpenException(
    ...
    OpenLog.warn(
        ...
        ex,
        "code",
        ex.getCode() != null ? ex.getCode().code() : null,
        "path",
  ...
  public ResponseEntity<OpenApiResponse<Object>> handleUnexpectedException(
    ...
    OpenApiResponse<Object> body =
        OpenApiResponse.failure(
            OpenErrorCodes.INTERNAL_ERROR.code(),
  ...
  */
  private HttpServletRequest extractRequest(WebRequest request) {
    ...
    if (request
        instanceof org.springframework.web.context.request.NativeWebRequest nativeWebRequest) {
