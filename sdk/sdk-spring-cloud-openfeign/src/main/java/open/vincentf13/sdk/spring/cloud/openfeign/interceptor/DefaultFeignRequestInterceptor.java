...
public class DefaultFeignRequestInterceptor implements RequestInterceptor {
    ...
    public DefaultFeignRequestInterceptor(
            FeignAuthorizationProvider authorizationProvider,
    ...
    private void attachTraceHeaders(RequestTemplate template) {
        ...
        if (!template.headers().containsKey(OpenConstant.HttpHeader.TRACE_ID.value())
