...
public class OpenFeignExceptionAdvice implements MessageSourceAware {
    ...
    public ResponseEntity<OpenApiResponse<Object>> handleRetryable(RetryableException ex,
    ...
    public ResponseEntity<OpenApiResponse<Object>> handleFeign(FeignException ex,
                                                               HttpServletRequest request) {
    ...
    public ResponseEntity<OpenApiResponse<Object>> handleDecode(DecodeException ex,
                                                                HttpServletRequest request) {
    ...
    public ResponseEntity<OpenApiResponse<Object>> handleEncode(EncodeException ex,
                                                                HttpServletRequest request) {
     ...
     */
    private void enrichWithFeignRequest(Map<String, Object> meta,
                                        FeignException ex) {
        if (ex.request() == null) {
            return;
        }
