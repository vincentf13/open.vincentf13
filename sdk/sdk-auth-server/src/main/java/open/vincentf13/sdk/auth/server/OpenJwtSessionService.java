...
public class OpenJwtSessionService {
    ...
    public IssueResult issue(Authentication authentication) {
        ...
        OpenLog.info(AuthServerEvent.JWT_SESSION_CREATED,
                     "sessionId", sessionId,
    ...
    public Optional<IssueResult> refresh(String refreshTokenValue) {
        ...
        if (!session.getUsername().equals(claims.subject())) {
            OpenLog.warn(AuthServerEvent.REFRESH_SUBJECT_MISMATCH,
                         "sessionId", sessionId,
        ...
        sessionStore.save(session);
        OpenLog.info(AuthServerEvent.JWT_SESSION_REFRESHED,
                     "sessionId", sessionId,
    ...
    public void revoke(String sessionId,
        ...
        OpenLog.info(AuthServerEvent.JWT_SESSION_REVOKED,
                     "sessionId", sessionId,
                     "reason", reason);
    }
    
    private Authentication buildAuthentication(JwtSession session,
