...
/**
 * Enumerates authentication-related failures so different entry points (login, refresh, etc.) can
 * present consistent error codes/messages.
 */
public enum FailureReason {
  ACCOUNT_LOCKED(
      HttpStatus.UNAUTHORIZED,
      "AUTH_ACCOUNT_LOCKED",
      "auth.login.failure.locked",
      "Account locked"),
  ACCOUNT_DISABLED(
      HttpStatus.UNAUTHORIZED,
      "AUTH_ACCOUNT_DISABLED",
      "auth.login.failure.disabled",
      "Account disabled or not activated"),
  CREDENTIALS_EXPIRED(
      HttpStatus.UNAUTHORIZED,
      "AUTH_CREDENTIALS_EXPIRED",
      "auth.login.failure.credentials-expired",
      "Password expired"),
  ACCOUNT_EXPIRED(
      HttpStatus.UNAUTHORIZED,
      "AUTH_ACCOUNT_EXPIRED",
      "auth.login.failure.account-expired",
      "Account expired"),
  BAD_CREDENTIALS(
      HttpStatus.UNAUTHORIZED,
