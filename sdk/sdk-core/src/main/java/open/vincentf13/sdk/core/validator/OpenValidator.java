...
public final class OpenValidator {
  ...
  public static void assertAllNotNull(Map<String, ?> namedValues) {
    Objects.requireNonNull(namedValues, "Values must not be null");
    for (Map.Entry<String, ?> entry : namedValues.entrySet()) {
      if (entry.getValue() == null) {
        throw new NullPointerException(entry.getKey() + " must not be null");
      }
    }
  }
