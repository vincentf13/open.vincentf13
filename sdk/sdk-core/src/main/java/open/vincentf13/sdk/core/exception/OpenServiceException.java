...
public class OpenServiceException extends RuntimeException implements OpenException {
    ...
    private OpenServiceException(OpenErrorCode error, String errorMessage, Map<String, Object> meta, Throwable rootCause) {
        super(OpenException.resolveMessage(error, errorMessage), rootCause);
        this.code = error.code();
        this.meta = mergeMeta(meta);
    }

    public static OpenServiceException of(OpenErrorCode error, String errorMessage) {
        return new OpenServiceException(error, errorMessage, null, null);
    }

    public static OpenServiceException of(OpenErrorCode error, String errorMessage, Throwable rootCause) {
        return new OpenServiceException(error, errorMessage, null, rootCause);
    }

    public static OpenServiceException of(OpenErrorCode error, String errorMessage, Map<String, Object> meta) {
        return new OpenServiceException(error, errorMessage, meta, null);
    }

    public static OpenServiceException of(OpenErrorCode error, String errorMessage, Map<String, Object> meta, Throwable rootCause) {
