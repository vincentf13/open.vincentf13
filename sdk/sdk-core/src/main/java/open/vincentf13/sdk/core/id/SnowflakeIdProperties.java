...
public class SnowflakeIdProperties {
   ...
   *
   * <p>This value can be configured via the application property {@code
   * open.vincentf13.id-generator.snowflake.worker-id} or the environment variable {@code
   * OPEN_VINCENTF13_IDGENERATOR_SNOWFLAKE_WORKERID}.
   *
