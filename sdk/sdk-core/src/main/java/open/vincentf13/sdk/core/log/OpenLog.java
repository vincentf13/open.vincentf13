...
public final class OpenLog {
    ...
    public static String info(OpenEvent event,
                              Object... kv) {
        Logger log = resolveLogger();
        if (!log.isInfoEnabled())
            return "Info Not Enabled";
        String finalLog = format(event, kv);
        log.info(finalLog);
        return finalLog;
    }
    
    public static String warn(OpenEvent event,
                              Object... kv) {
        Logger log = resolveLogger();
    ...
    public static String error(OpenEvent event,
                               Throwable t,
                               Object... kv) {
        Logger log = resolveLogger();
    ...
    public static String debug(OpenEvent event,
                               Object... kv) {
        Logger log = resolveLogger();
    ...
    public static String trace(OpenEvent event,
                               Object... kv) {
        Logger log = resolveLogger();
    ...
    private static String format(OpenEvent event,
                                 Object... kv) {
