...
public final class OpenLog {
    ...
    public static String info(Logger log,
                              OpenEvent event,
                              Object... kv) {
    ...
    public static String warn(Logger log,
                              OpenEvent event,
                              Object... kv) {
    ...
    public static String error(Logger log,
                               OpenEvent event,
                               Throwable t,
                               Object... kv) {
    ...
    public static String debug(Logger log,
                               OpenEvent event,
                               Object... kv) {
    ...
    public static String trace(Logger log,
                               OpenEvent event,
                               Object... kv) {
