...
public final class OpenKafkaProducer {
    ...
    public static void initialize(KafkaTemplate<String, Object> template,
                                  ObjectMapper mapper) {
    ...
    public static <T> CompletableFuture<SendResult<String, Object>> send(String topic,
        ...
        try {
            ...
            OpenLog.debug(KafkaEvent.KAFKA_SEND,
                          "topic", topic,
                          "key", key,
    ...
    private static void addHeaders(ProducerRecord<String, Object> record,
                                   Map<String, Object> headers) {
    ...
    private static void logResult(
        ...
        if (metadata != null) {
            OpenLog.debug(KafkaEvent.KAFKA_SEND_SUCCESS,
