...
public class ApiKeyFilter extends OncePerRequestFilter {
  ...
  public ApiKeyFilter(
      ApiKeyValidator apiKeyValidator, RequestMappingHandlerMapping handlerMapping) {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      // A more robust solution might involve inspecting the request attributes set by the
      // dispatcher servlet.
  ...
  private PrivateAPI findPrivateApiAnnotation(HandlerMethod handlerMethod) {
    PrivateAPI annotation =
        AnnotationUtils.findAnnotation(handlerMethod.getMethod(), PrivateAPI.class);
    if (annotation == null) {
