...
/**
 ...
 <ul>
 <li>全域旗標：system property {@code open.vincentf13.sdk.core.test.testcontainer.enabled} 或環境變數
 {@code OPEN_VINCENTF13_SDK_CORE_TEST_TESTCONTAINER_ENABLED}
 <li>服務別旗標：system property {@code open.vincentf13.sdk.core.test.testcontainer.<name>.enabled}
 </ul>
...
final class TestContainerSettings {
    ...
    private static final String PROPERTY_PREFIX =
            OpenConstant.Package.Names.BASE_PACKAGE + ".common.core.test.testcontainer.";
    ...
    private static Boolean readFlag(String propertyKey,
                                    String envKey) {
