...
└─ services/                            # 具體業務服務
   ...
   │   │       └─ repository/UserRepository.java     # Repository 介面：隱藏 MyBatis 細節，返回 Domain User 實體
   │   │           └─ UserRepositoryImpl.java        # 实作採命名「RepositoryImpl」，透過 OpenMapstruct 完成 UserPO ↔ User 轉換
   │   │                                             # 並在 @Transactional 區塊內由上層控制提交
