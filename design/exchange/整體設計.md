...
| -------------- | --------------------------- | ------------------------- | ------------------------------------------- | ---------------- | ------------------------------------------------------------------- | ---- | ---- | ---- |
| positions      | positions.reserve-requested | `PositionReserved`        | 預凍結成功 → 更新 `SUBMITTED` 並補發 `OrderSubmitted` | `OrderSubmitted` | update `orders`<status=SUBMITTED, submitted_at=now>                 | -    | -    | -    |
| positions      | positions.reserve-requested | `PositionReserveRejected` | 預凍結失敗 → 訂單 `FAILED`                         | -                | update `orders`<status=FAILED>                                      | -    | -    | -    |
...
| matching       | matching.trade-executed     | `TradeExecuted`           | 更新成交量、均價、手續費與 `filled_at`                   | -                | update `orders`<status=PARTIAL_FILLED/FILLED, filled_at=executedAt> | -    | -    | -    |
