...
└─ services/                            # 具體業務服務
   ...
   │   │       └─ UserDomainService.java    # Email 正規化、建立聚合等邏輯
   ...
   │   │   └─ service/UserApplicationService.java # Application Service，用例流程協調
   │   └─ interfaces/                   # Controller / API 實作
   │       ├─ rest/UserController.java       # REST Controller
   │       └─ dto/*.java                     # 請求/回應 DTO 定義
