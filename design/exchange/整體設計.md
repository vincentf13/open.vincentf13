...
| ----------- | --------------------------------- | -------------- | --------------- | ------- | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ---- | ---- |
| POST        | `/api/risk/precheck/order`        | （同步）下單預檢與保證金試算 | positions/order | private | OrderPrecheckRequest(userId,instrumentId,price,qty,leverage)                                 | OrderPrecheckResult(allow, requiredMargin, reason)          | -    | -    |
