...
| 完成  | Topic                   | 事件                   | 處理邏輯                | 事件發布                                 | IO操作                                                                             |
| --- | ----------------------- | -------------------- | ------------------- | ------------------------------------ | -------------------------------------------------------------------------------- |
|     | matching.trade-executed | `TradeExecuted`      | 調整倉位數量、均價與未實現盈虧     | `PositionUpdated` / `PositionClosed` | DB: update `positions`<quantity, entry_price, unrealized_pnl, liquidation_price> |
