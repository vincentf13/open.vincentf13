package open.vincentf13.common.infra.kafka;
...
public final class OpenKafkaProducer {
    ...
    public static <T> CompletableFuture<SendResult<String, byte[]>> send(String topic,
                                                                         String key,
                                                                         T msg,
        ...
        try {
            ...
            CompletableFuture<SendResult<String, byte[]>> sendFuture = adaptFuture(
    ...
    private static void addHeaders(ProducerRecord<String, byte[]> record, Map<String, Object> headers) {
